...
- Design system próprio (v65): cartão de valor em destaque, painel em duas colunas no computador e cards de escala com a cor da situação. Detalhes em [docs/DESIGN.md](docs/DESIGN.md).
